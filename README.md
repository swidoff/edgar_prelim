...
The committed [sqlite database file](https://github.com/swidoff/edgar_prelim/blob/master/edgar_prelim/resources/edgar_prelim.db) 
contains the following preliminary income statement items and ratios for preliminary announcements from the largest 
373 US banks (by total assets) through 2019Q1:
...
There is a lot of variety between companies on the format of the income statement tables, but it is not unlimited. 
edgar_prelim combs through all company 8-Ks and:
